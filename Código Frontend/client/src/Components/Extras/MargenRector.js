...
import { faIdCard, faBars } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className="row">
                    ...
                    <div className="col-12 d-lg-none">
                        ...
                        <div className={`container-fluid mt-2 ${menuOpen ? '' : 'd-none'}`} style={{ backgroundColor: '#011F5D' }}>
                            <div className="container-fluid d-flex align-items-center justify-content-center flex-column">
                                <div className="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center" style={{ width: '60px', height: '60px', marginTop: '20px' }}>
                                    <span className="h2">
                                        <FontAwesomeIcon icon={faIdCard} size="sm" />
                                    </span>
                                </div>
                                <div>
                                    <Link to="/" className="nav-link text-white">Editar perfil</Link>
                                </div>
                                <div>
                                    <button className="nav-link text-white" onClick={handleLogout}>Salir</button>
                                </div>
