                ...
                <div className="row">
                    <div className="col-12 col-lg-1 d-none d-lg-block position-fixed vh-100 p-0" style={{ backgroundColor: '#011F5D' }}>
                        <div className="container-fluid d-flex align-items-center justify-content-center flex-column">
                            <div className="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center mb-4" style={{ width: '60px', height: '60px', marginTop: '20px' }}>
                                <span className="h2">
                                    <FontAwesomeIcon icon={faUserShield} size="sm" />
                                </span>
                            </div>
                            <div>
                                <Link to="/cambioA" className="nav-link text-white mb-4">Editar perfil</Link>
                            </div>
                            <div>
                            ...
                            <div className="d-flex flex-column justify-content-center align-items-center">
                                <ul className="navbar-nav mt-lg-5">
                                    <li className="nav-item">
                                        <Link to="/Iniciousuario" className="nav-link text-white">Administración de usuarios</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/Parametros" className="nav-link text-white">Administración de parámetros</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
