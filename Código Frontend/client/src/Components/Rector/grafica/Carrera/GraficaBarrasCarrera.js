...
const GraficaBarraCarrera = () => {
    const BASE_PATH = ENV.BASE_PATH;
    const RouteABPC = ENV.API_ROUTES.Z5pmoaUSeuZD6ARgshQZbcWoUVEhdaEZETkplurq5pDKkDI5N6jPACA;
    ...
    const exportToExcel = async () => {
        try {
            ...
            const worksheet = workbook.addWorksheet('Datos de carreras');
...
export default GraficaBarraCarrera;
